package com.zartio.betterendgame.data.entity.leeched_experience_orb.client;
...
public class LeechedExperienceOrbEntityRenderer extends EntityRenderer<LeechedExperienceOrbEntity> {
    ...
    public LeechedExperienceOrbEntityRenderer(EntityRendererFactory.Context context) {
        super(context);
        this.shadowRadius = 0.15F;
        this.shadowOpacity = 0.75F;
    }

    protected int getBlockLight(LeechedExperienceOrbEntity experienceOrbEntity, BlockPos blockPos) {
        return MathHelper.clamp(super.getBlockLight(experienceOrbEntity, blockPos) + 7, 0, 15);
    }

    public void render(LeechedExperienceOrbEntity experienceOrbEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
        int j = 4; // experienceOrbEntity.getOrbSize();
    ...
    @Override
    public Identifier getTexture(LeechedExperienceOrbEntity entity) {
        return TEXTURE;
    }
}
